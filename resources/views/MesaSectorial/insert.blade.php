                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control" name="nombre_sector" id="basicInput" placeholder=" ingrese el sector" required/>
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                ...
                                <input type="text" id="helperText" name="codigo" class="form-control" placeholder="ingrese el codigo de la mesa" required/>
