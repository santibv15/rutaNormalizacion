                                            ...
                                            <form>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-1">
                                                        <label for="cedula_func" class="form-label">{{ __('Cedula:') }}</label>
                                                            <input id="cedula_func" type="text" class="form-control @error('cedula_func') is-invalid @enderror" name="cedula_func" value="{{ old('cedula_func') }}" required autocomplete="name" placeholder="Ingrese su Cedula"  autofocus>
                                                    ...
                                                    <div class="col-md-6 mb-1">
                                                        <label for="name" class="form-label">{{ __('Nombre:') }}</label>
                                                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Ingrese su nombre"  autofocus>
                                                    ...
                                                    <div class="col-md-6 mb-1">
                                                        <label for="email" class="form-label">{{ __('Correo Personal') }}</label>
                                                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Ingrese su correo Personal">
                                                    ...
                                                    <div class="col-md-6 mb-1">
                                                        <label for="correo_insti_func" class="form-label">{{ __('Correo Institucional') }}</label>
                                                            <input id="correo_insti_func" type="email" class="form-control @error('correo_insti_func') is-invalid @enderror" name="correo_insti_func" value="{{ old('correo_insti_func') }}" required autocomplete="correo_insti_func" placeholder="Ingrese su correo institucional">
                                                    ...
                                                    <div class="col-md-6 mb-1">
                                                        <label for="tel_func" class="form-label">{{ __('Tel: ') }}</label>
                                                            <input id="tel_func" type="text" class="form-control @error('tel_func') is-invalid @enderror" name="tel_func" value="{{ old('tel_func') }}" required autocomplete="tel_func" placeholder="Ingrese su numero telefonico">
                                                    ...
                                                    <div class="col-md-6 mb-1">
                                                        <label for="rol" class="form-label">{{ __('Rol: ') }}</label>
                                                            <input id="rol" type="text" class="form-control @error('rol') is-invalid @enderror" name="rol" value="{{ old('rol') }}" required autocomplete="tel_func" placeholder="Ingrese su rol">
